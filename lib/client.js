...
Client.prototype._pulseQueryQueue = function () {
  global.__KNEXBADEBUG.log(this.connection._connID, "pg pulse queue " + (this.readyForQuery === true));
...
Client.prototype.query = function (config, values, callback) {
  global.__KNEXBADEBUG.log(config, "pg query START " + (this.connection && this.connection._connID));
